...
EXPERIMENT_NAME = 'Wine_Notebook_Example'
...
PRINT_FREQ = 250
EVAL_FREQ = 250
CONT_INPUTS = ['alcohol', 'malic_acid', 'ash', 'alkalinity', 'magnesium',
               'phenols', 'flavanoids', 'nonflavanoid_phenols', 'proanthocyanins',
               'color_intensity', 'hue', 'dilution', 'proline']  # Names of features in df that are continuous (not categorical)
INT_INPUTS = ['magnesium', 'proline']  # Names of features in df that should be integers
DEP_VAR = 'class'  # Name of dependent variable
...
TEST_RANGES = [90, 180, 360, 720, 1440]  # Various multiples of training set size
